...
for ticker, stock_name, sector in STOCKS:
    ...
    try:
        ...
        X_last = data['X_test'][-1:]  # Shape: (1, 60, 39) - includes Advanced Signals features
        ...
        # 3. Make prediction
        print(f"\n3. Making prediction with Advanced Signals features...")
...
if all_predictions:
    ...
    print("\n" + "=" * 80)
    print("TRADING RECOMMENDATIONS WITH ENTRY/EXIT POINTS (Advanced Signals)".center(80))
    print("=" * 80)
    ...
    if len(strong_buys) > 0:
        ...
        for _, row in strong_buys.iterrows():
            ...
            print(f"   ✅ JUSTIFICATION: Advanced Signals high confidence ({row['Direction_Confidence']:.1f}%) upward prediction")
    ...
    if len(strong_sells) > 0:
        ...
        for _, row in strong_sells.iterrows():
            ...
            print(f"   ✅ JUSTIFICATION: Advanced Signals high confidence ({row['Direction_Confidence']:.1f}%) downward prediction")
...
print("sentiment analysis (39 features: 35 technical + 4 Advanced Signals sentiment).")
